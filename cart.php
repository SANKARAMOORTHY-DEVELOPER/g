...
<section class="shopping-cart">
   ...
   <form action="" method="POST" class="box">
      ...
      <div class="price">values<?= $fetch_cart['price']; ?>/-</div>
      <input type="hidden" name="cart_id" value="<?= $fetch_cart['id']; ?>">
      <div class="flex-btn">
         <input type="number" min="1" value="<?= $fetch_cart['quantity']; ?>" class="qty" name="p_qty">
         <input type="submit" value="update" name="update_qty" class="option-btn">
      </div>
      <div class="sub-total"> sub total : <span>values<?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</span> </div>
   </form>
   <?php
   ...
   <div class="cart-total">
      <!--<p>grand total : <span>values<?= $grand_total; ?>/-</span></p> -->
      <a href="shop.php" class="option-btn">Continue Surfing</a>
